...
<head>
    ...
    <style>
        ...
        select { width: 100%; padding: 10px; border-radius: 8px; border: 1px solid var(--glass-border); background: transparent; color: var(--text-main); }
...
<body style="display: flex; flex-direction: column; align-items: center; padding: 40px 20px; min-height: 100vh;">
    <div style="max-width: 600px; width: 100%;">
        ...
        <!-- FIX: Points to the correct action file -->
