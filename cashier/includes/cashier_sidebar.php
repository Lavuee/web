<aside class="sidebar">
    ...
    <nav style="flex: 1;">
        <a href="dashboard.php" class="nav-link <?= ($current_page == 'dashboard.php') ? 'active' : '' ?>">Payment Verification</a>
        <a href="payment_history.php" class="nav-link <?= ($current_page == 'payment_history.php') ? 'active' : '' ?>">Payment History</a>
    </nav>
